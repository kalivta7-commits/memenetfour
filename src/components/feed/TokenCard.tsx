  ...
  return (
    <div className="tc-event-row">
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p className="tc-event-title truncate max-w-full">{event.title}</p>
        {event.description && (
          <p className="tc-event-desc line-clamp-2 max-w-full">{event.description}</p>
        )}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4, minWidth: 0, flexWrap: 'wrap' }}>
          <ScoreBar score={event.score} />
          <span className="tc-event-time flex-shrink-0">
